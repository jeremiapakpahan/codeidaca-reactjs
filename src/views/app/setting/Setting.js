...
//8. useDispatch digunakan untuk mentrigger event dan untuk fetching state digunakan selector
...
export default function SettingProfile() {
    ...
    const { talent } = useSelector((state) => state.talentState)//useSelector akan mengakses talentState untuk mendapat data dari reducer dan diambil objek talentnya
