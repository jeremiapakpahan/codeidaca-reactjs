...
//6.setiap kali view layer trigger melakukan request middleware akan mendeteksi semua request
//function watchAll akan mendeteksi action type yg di request makan akan 
//mentrigger function handle yang ada di saga
function *watchAll() {
  yield all([
